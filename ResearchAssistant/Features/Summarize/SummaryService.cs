...
public class SummaryService
{
    ...
    public SummaryService(ChunkingService chunkingService, IConfiguration configuration)
    {
    ...
    public async Task Summarize(HttpContext httpContext, SummaryRequest request)
    {
        ...
        foreach (var chunk in chunks)
        {
            ...
            await foreach (var stream in _ollamaApiClient.GenerateAsync($"Make a 50 words summary for this text: {chunk}"))
            {
